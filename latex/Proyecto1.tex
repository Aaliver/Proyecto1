...
\setlist[itemize]{label=\textcolor{maincolor}{\alph*}, left=1.5em}
...
usando el modelo de la cascada, así como practicas como las pruebas unitarias o
el código limpio, que no solo facilitan el desarrollo de proyectos, si no que
